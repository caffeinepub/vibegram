...
export const ALL_SONGS: Song[] = [
  ...
  { title: "Future Nostalgia", artist: "Dua Lipa", genre: "Pop" },
  ...
  { title: "Heat Waves", artist: "Glass Animals", genre: "Pop" },
  { title: "Easy On Me", artist: "Adele", genre: "Pop" },
  { title: "Hello", artist: "Adele", genre: "Pop" },
  { title: "Someone Like You", artist: "Adele", genre: "Pop" },
  { title: "Uptown Funk", artist: "Bruno Mars ft. Mark Ronson", genre: "Pop" },
  ...
  { title: "All The Stars", artist: "Kendrick Lamar", genre: "Hip-Hop" },
  ...
  { title: "HIGHEST IN THE ROOM", artist: "Travis Scott", genre: "Hip-Hop" },
  { title: "Money Trees", artist: "Kendrick Lamar", genre: "Hip-Hop" },
  { title: "Lucid Dreams", artist: "Juice WRLD", genre: "Hip-Hop" },
  { title: "Legends Never Die", artist: "Juice WRLD", genre: "Hip-Hop" },
  { title: "Congratulations", artist: "Post Malone", genre: "Hip-Hop" },
  { title: "Stay", artist: "The Kid LAROI", genre: "Hip-Hop" },
  { title: "Savage", artist: "Megan Thee Stallion", genre: "Hip-Hop" },
  { title: "WAP", artist: "Cardi B", genre: "Hip-Hop" },
  ...
  { title: "Ik Vaari Aa", artist: "Arijit Singh", genre: "Bollywood" },
  { title: "Channa Mereya", artist: "Arijit Singh", genre: "Bollywood" },
  { title: "Judaai", artist: "Arijit Singh", genre: "Bollywood" },
  { title: "Dil Diyan Gallan", artist: "Atif Aslam", genre: "Bollywood" },
  { title: "Pehla Nasha", artist: "Udit Narayan", genre: "Bollywood" },
  { title: "Tera Ban Jaunga", artist: "Akhil Sachdeva", genre: "Bollywood" },
  {
    title: "Ve Maahi",
  ...
  { title: "Bekhayali", artist: "Sachet Tandon", genre: "Bollywood" },
  {
    title: "Senorita",
    artist: "Shawn Mendes & Camila Cabello",
    genre: "Bollywood",
  },
  { title: "Dheeme Dheeme", artist: "Tony Kakkar", genre: "Bollywood" },
  { title: "Lut Gaye", artist: "Jubin Nautiyal", genre: "Bollywood" },
  { title: "Teri Aankhon Mein", artist: "Darshan Raval", genre: "Bollywood" },
  { title: "Raat Bhar", artist: "Jubin Nautiyal", genre: "Bollywood" },
  { title: "Ek Tara", artist: "Lucky Ali", genre: "Bollywood" },
  { title: "Pachtaoge", artist: "Arijit Singh", genre: "Bollywood" },
  { title: "Duniyaa", artist: "Akhil & Dhvani Bhanushali", genre: "Bollywood" },
  { title: "Galliyan", artist: "Ankit Tiwari", genre: "Bollywood" },
  { title: "Khairiyat", artist: "Arijit Singh", genre: "Bollywood" },
  { title: "Aise Kyun", artist: "Udit Narayan", genre: "Bollywood" },
  { title: "Sajni", artist: "Jal Band", genre: "Bollywood" },
  { title: "Tere Sang Yaara", artist: "Atif Aslam", genre: "Bollywood" },
  { title: "Aadat", artist: "Atif Aslam", genre: "Bollywood" },
  { title: "Woh Lamhe", artist: "Atif Aslam", genre: "Bollywood" },
  { title: "Tu Jaane Na", artist: "Atif Aslam", genre: "Bollywood" },
  { title: "Pani Da Rang", artist: "Ayushmann Khurrana", genre: "Bollywood" },
  { title: "Sooraj Dooba Hai", artist: "Arijit Singh", genre: "Bollywood" },
  {
  ...
  { title: "good 4 u", artist: "Olivia Rodrigo", genre: "R&B" },
  { title: "Peaches", artist: "Justin Bieber ft. Daniel Caesar", genre: "R&B" },
  { title: "MONTERO", artist: "Lil Nas X", genre: "R&B" },
  { title: "Waterfall", artist: "Tyla", genre: "R&B" },
  { title: "Water", artist: "Tyla", genre: "R&B" },
  { title: "Golden", artist: "Harry Styles", genre: "R&B" },
  { title: "Die For You", artist: "The Weeknd", genre: "R&B" },
  { title: "Earned It", artist: "The Weeknd", genre: "R&B" },
  { title: "Often", artist: "The Weeknd", genre: "R&B" },
  // EDM
  { title: "Blinding Lights", artist: "The Weeknd", genre: "EDM" },
  { title: "Save Your Tears", artist: "The Weeknd", genre: "EDM" },
  {
  ...
  { title: "Without You", artist: "David Guetta", genre: "EDM" },
  ...
  { title: "The Nights", artist: "Avicii", genre: "EDM" },
  { title: "Faded", artist: "Alan Walker", genre: "EDM" },
  { title: "Alone", artist: "Alan Walker", genre: "EDM" },
  { title: "On My Way", artist: "Alan Walker", genre: "EDM" },
  { title: "Spectre", artist: "Alan Walker", genre: "EDM" },
  { title: "Roses", artist: "SAINt JHN", genre: "EDM" },
  { title: "Skyfall", artist: "Zedd", genre: "EDM" },
  { title: "Beautiful Now", artist: "Zedd", genre: "EDM" },
  { title: "Stay The Night", artist: "Zedd ft. Hayley Williams", genre: "EDM" },
  { title: "Unity", artist: "TheFatRat", genre: "EDM" },
  { title: "The Calling", artist: "TheFatRat", genre: "EDM" },
];
